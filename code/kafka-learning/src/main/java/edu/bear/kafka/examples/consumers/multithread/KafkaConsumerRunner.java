...
import edu.bear.kafka.examples.producers.HelloProducer;
...
public class KafkaConsumerRunner implements Runnable {
    ...
    public KafkaConsumerRunner(int id, String groupID, List<String> topics) {
        ...
        properties.put(ConsumerConfig.CLIENT_ID_CONFIG, applicationID + "-" + id);
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, AppConfigs.groupName);
