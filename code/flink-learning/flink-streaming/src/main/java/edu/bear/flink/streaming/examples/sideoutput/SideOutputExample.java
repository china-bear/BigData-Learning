...
package edu.bear.flink.streaming.examples.sideoutput;

import edu.bear.flink.streaming.examples.wordcount.WordCountData;
 ...
 * edu.bear.flink.streaming.examples.windowing.WindowWordCount} that has a filter in the tokenizer
