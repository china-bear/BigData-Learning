...
package edu.bear.flink.table.examples.java.connectors;
 ...
 *
 * <p>The {@link edu.bear.flink.table.examples.java.connectors.SocketDynamicTableSource} uses a simple single-threaded {@link SourceFunction} to
