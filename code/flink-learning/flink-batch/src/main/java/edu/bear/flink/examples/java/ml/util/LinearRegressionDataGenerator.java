...
package edu.bear.flink.examples.java.ml.util;
...
/**
 * Generates data for the {@link edu.bear.flink.examples.java.ml.LinearRegression} example
 * program.
 */
public class LinearRegressionDataGenerator {
     ...
     * edu.bear.flink.examples.java.ml.LinearRegression} example program.
     *
