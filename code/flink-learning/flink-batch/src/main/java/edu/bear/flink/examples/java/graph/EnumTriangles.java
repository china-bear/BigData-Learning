...
package edu.bear.flink.examples.java.graph;

import edu.bear.flink.examples.java.graph.util.EnumTrianglesData;
import edu.bear.flink.examples.java.graph.util.EnumTrianglesDataTypes;
...
import edu.bear.flink.examples.java.graph.util.EnumTrianglesData;
import edu.bear.flink.examples.java.graph.util.EnumTrianglesDataTypes.Edge;
import edu.bear.flink.examples.java.graph.util.EnumTrianglesDataTypes.Triad;
