...
package edu.bear.flink.examples.java.relational;

import edu.bear.flink.examples.java.relational.util.WebLogData;
 ...
 * edu.bear.flink.examples.java.relational.util.WebLogDataGenerator} and have the following
 * schemas
 *
 * <pre>{@code
